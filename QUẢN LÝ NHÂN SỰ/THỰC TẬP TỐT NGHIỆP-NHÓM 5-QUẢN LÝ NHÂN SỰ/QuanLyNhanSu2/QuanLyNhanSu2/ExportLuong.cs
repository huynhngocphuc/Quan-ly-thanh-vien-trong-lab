...
namespace QuanLyNhanSu2
{
    //class ExportLuong
    //{
    //    public void ExportExcelLuong(DataTable dt, string SheetName, string title)
    //    {
    ...
    //        Microsoft.Office.Interop.Excel.Range head = sheet.get_Range("A1", "O1");
    ...
    //        cl3.Value2 = "Phòng ban";

    //        cl3.ColumnWidth = 40.5;
    ...
    //        cl9.Value2 = "Khấu trừ BH";
    //        cl9.ColumnWidth = 21.0;
